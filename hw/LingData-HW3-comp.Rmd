...
```
Here we can see that unlike in the 1920s sample p-value is much smaller that alpha. This means that we can reject the null hypothesis and conclude verbs were used more or less frequently than usual in the 1820s. So apparently, during the period from 1820s to 1920s verbs stopped being used with different frequency from other parts of speech.
```
